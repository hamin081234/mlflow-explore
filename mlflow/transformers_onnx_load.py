...
print(f"loading_time: {time()-start_time}")  # 40.36700677871704 seconds
...
print(f"first inference duration: {results[0]['total_dur']}")  # 0.6825704574584961 seconds
print(f"mean inference duration: {np.mean([result['total_dur'] for result in results])}")  # 0.34239665667215985 seconds
print(f"mean inference duration without first: {np.mean([result['total_dur'] for result in results][1:])}")  # 0.27436189651489257 seconds
